...
funcs = [Python_Exercises.power, Python_Exercises.split_str, Python_Exercises.format, Python_Exercises.indexing,
         Python_Exercises.dictionary, Python_Exercises.subjective, Python_Exercises.domainGet,
...
test_cases = {
         ...
         'indexing' : [([1,2,[3,4],[5,[100,200,['hello']],23,11],1,7]),lst[3][1][2][0]
              ],
                  'subjective' : [['',immutable]],
                  'dictionary' : [({'k1':[1,2,3,{'tricky':['oh','man','inception',{'target':[1,2,3,'hello']}]}]}),(d['k1'][3]['tricky'][3]['target'][3])],
