...
def format(planet, diameter):
    ...
    return str.format(planet, diameter)
...
def countDog(st):
    # ** Create a function that counts the number of times the word "dog" occurs in a string. Again ignore edge
    # cases. **
