...
#     ['soup','salad']
    ...
    lst = list(filter(lambda i : (i[0]=='s'),seq))
    return lst
...
#   Ticket". Unless it is your birthday (encoded as a boolean value in the parameters of the function) -- on your birthday, your speed can be 5 higher in all 
#   cases. **
    if is_birthday == True :
      if speed<=65 :
        return "No Ticket" 
